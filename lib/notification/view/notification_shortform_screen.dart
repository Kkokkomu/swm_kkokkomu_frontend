...
class NotificationShortFormScreen extends ConsumerWidget {
  static String get routeName => 'notification-shortform';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (newsId == Constants.unknownErrorId ||
        shortFormUrl == Constants.unknownErrorString ||
        user is! UserModel) {
      debugPrint('유저의 상태가 올바르지 않거나 newsId 또는 shortFormUrl이 null 값입니다.');

      return CustomShortFormBase(
        shortFormScreenType: ShortFormScreenType.notification,
        child: Center(
          child: Column(
