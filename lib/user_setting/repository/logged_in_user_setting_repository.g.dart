...
class _LoggedInUserSettingRepository implements LoggedInUserSettingRepository {
  ...
  @override
  Future<ResponseModel<HidedUserModel?>> getHidedUserList() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'accessToken': true};
    _headers.removeWhere((k, v) => v == null);
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ResponseModel<HidedUserModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ResponseModel<HidedUserModel?>.fromJson(
      _result.data!,
      (json) => json == null
          ? null
          : HidedUserModel.fromJson(json as Map<String, dynamic>),
    );
    return value;
  }
