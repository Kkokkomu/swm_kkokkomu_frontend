...
import 'package:swm_kkokkomu_frontend/exploration/repository/logged_in_user_explore_shortform_repository.dart';
...
final loggedInUserExploreShortFormProvider = StateNotifierProvider.autoDispose<
    LoggedInUserExploreShortFormStateNotifier, CursorPaginationBase>(
  (ref) {
    final exploreShortFormRepository =
        ref.watch(loggedInUserExploreShortFormRepositoryProvider);
    final category = ref.watch(explorationCategoryProvider);

    return LoggedInUserExploreShortFormStateNotifier(
...
class LoggedInUserExploreShortFormStateNotifier
    extends CursorPaginationProvider<ShortFormModel,
        LoggedInUserExploreShortFormRepository> {
  final Ref ref;

  LoggedInUserExploreShortFormStateNotifier(
    super.repository, {
    required this.ref,
